...
/**
 * Componente `BannerSpecificMaterial` que renderiza un banner con un fondo personalizado,
 ...
 */
const BannerSpecificMaterial = ({ titulo, parrafo, tipo, backgroundImage }) => {
    return (
        <div
...
export default BannerSpecificMaterial
